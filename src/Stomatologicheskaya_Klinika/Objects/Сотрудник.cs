...
namespace IIS.Stomatologicheskaya_Klinika
{
    ...
    public class Сотрудник : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Stomatologicheskaya_Klinika.Должность fДолжность;
        ...
        [PropertyStorage(new string[] {
                "Должность"})]
        [NotNull()]
        public virtual IIS.Stomatologicheskaya_Klinika.Должность Должность
        {
            get
            {
                ...
                IIS.Stomatologicheskaya_Klinika.Должность result = this.fДолжность;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View СотрудникE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СотрудникE", typeof(IIS.Stomatologicheskaya_Klinika.Сотрудник));
                }
            }
            ...
            public static ICSSoft.STORMNET.View СотрудникL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СотрудникL", typeof(IIS.Stomatologicheskaya_Klinika.Сотрудник));
                }
            }
        }
    }
