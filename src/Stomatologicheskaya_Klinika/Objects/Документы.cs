...
namespace IIS.Stomatologicheskaya_Klinika
{
    ...
    public class Документы : ICSSoft.STORMNET.DataObject
    {
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Stomatologicheskaya_Klinika.Клиент.
        /// </summary>
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ДокументыE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ДокументыE", typeof(IIS.Stomatologicheskaya_Klinika.Документы));
                }
            }
        }
    }
    ...
    public class DetailArrayOfДокументы : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Stomatologicheskaya_Klinika.DetailArrayOfДокументы members)

        // *** End programmer edit section *** (IIS.Stomatologicheskaya_Klinika.DetailArrayOfДокументы members)
        ...
        /// </summary>
        public DetailArrayOfДокументы(IIS.Stomatologicheskaya_Klinika.Клиент fКлиент) : 
                base(typeof(Документы), ((ICSSoft.STORMNET.DataObject)(fКлиент)))
        {
        }
        
        public IIS.Stomatologicheskaya_Klinika.Документы this[int index]
        {
            get
            {
                return ((IIS.Stomatologicheskaya_Klinika.Документы)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Stomatologicheskaya_Klinika.Документы dataobject)
        {
