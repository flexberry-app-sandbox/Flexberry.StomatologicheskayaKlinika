...
namespace IIS.Stomatologicheskaya_Klinika
{
    ...
    public class Оплата : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Stomatologicheskaya_Klinika.ТипОплаты fТипОплаты;
        ...
        public virtual IIS.Stomatologicheskaya_Klinika.ТипОплаты ТипОплаты
        {
            get
            {
                ...
                IIS.Stomatologicheskaya_Klinika.ТипОплаты result = this.fТипОплаты;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ОплатаE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ОплатаE", typeof(IIS.Stomatologicheskaya_Klinika.Оплата));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ОплатаL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ОплатаL", typeof(IIS.Stomatologicheskaya_Klinika.Оплата));
                }
            }
        }
    }
