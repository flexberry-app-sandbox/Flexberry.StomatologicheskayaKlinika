...
namespace IIS.Stomatologicheskaya_Klinika
{
    ...
    public class Материал : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Stomatologicheskaya_Klinika.Производитель fПроизводитель;
        ...
        [PropertyStorage(new string[] {
                "Производитель"})]
        [NotNull()]
        public virtual IIS.Stomatologicheskaya_Klinika.Производитель Производитель
        {
            get
            {
                ...
                IIS.Stomatologicheskaya_Klinika.Производитель result = this.fПроизводитель;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View МатериалE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("МатериалE", typeof(IIS.Stomatologicheskaya_Klinika.Материал));
                }
            }
            ...
            public static ICSSoft.STORMNET.View МатериалL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("МатериалL", typeof(IIS.Stomatologicheskaya_Klinika.Материал));
                }
            }
        }
    }
