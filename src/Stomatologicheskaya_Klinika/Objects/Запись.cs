...
namespace IIS.Stomatologicheskaya_Klinika
{
    ...
    public class Запись : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Stomatologicheskaya_Klinika.Кабинет fКабинет;
        
        private IIS.Stomatologicheskaya_Klinika.Сотрудник fСотрудник;
        
        private IIS.Stomatologicheskaya_Klinika.Клиент fКлиент;
        
        private IIS.Stomatologicheskaya_Klinika.DetailArrayOfОказаниеУслуг fОказаниеУслуг;
        ...
        [PropertyStorage(new string[] {
                "Кабинет"})]
        [NotNull()]
        public virtual IIS.Stomatologicheskaya_Klinika.Кабинет Кабинет
        {
            get
            {
                ...
                IIS.Stomatologicheskaya_Klinika.Кабинет result = this.fКабинет;
        ...
        [PropertyStorage(new string[] {
                "Клиент"})]
        [NotNull()]
        public virtual IIS.Stomatologicheskaya_Klinika.Клиент Клиент
        {
            get
            {
                ...
                IIS.Stomatologicheskaya_Klinika.Клиент result = this.fКлиент;
        ...
        public virtual IIS.Stomatologicheskaya_Klinika.DetailArrayOfОказаниеУслуг ОказаниеУслуг
        {
            get
            {
                ...
                {
                    this.fОказаниеУслуг = new IIS.Stomatologicheskaya_Klinika.DetailArrayOfОказаниеУслуг(this);
                }
                IIS.Stomatologicheskaya_Klinika.DetailArrayOfОказаниеУслуг result = this.fОказаниеУслуг;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ЗаписьE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЗаписьE", typeof(IIS.Stomatologicheskaya_Klinika.Запись));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ЗаписьL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЗаписьL", typeof(IIS.Stomatologicheskaya_Klinika.Запись));
                }
            }
        }
    }
