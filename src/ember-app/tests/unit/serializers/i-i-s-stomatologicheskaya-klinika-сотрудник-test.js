...
moduleForModel('i-i-s-stomatologicheskaya-klinika-сотрудник', 'Unit | Serializer | i-i-s-stomatologicheskaya-klinika-сотрудник', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-stomatologicheskaya-klinika-сотрудник',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
