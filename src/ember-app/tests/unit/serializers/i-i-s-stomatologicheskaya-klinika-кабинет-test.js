...
moduleForModel('i-i-s-stomatologicheskaya-klinika-кабинет', 'Unit | Serializer | i-i-s-stomatologicheskaya-klinika-кабинет', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-stomatologicheskaya-klinika-кабинет',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
