...
moduleForModel('i-i-s-stomatologicheskaya-klinika-клиент', 'Unit | Serializer | i-i-s-stomatologicheskaya-klinika-клиент', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-stomatologicheskaya-klinika-клиент',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
