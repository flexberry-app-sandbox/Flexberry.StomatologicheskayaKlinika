...
moduleForModel('i-i-s-stomatologicheskaya-klinika-материал', 'Unit | Serializer | i-i-s-stomatologicheskaya-klinika-материал', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-stomatologicheskaya-klinika-материал',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
