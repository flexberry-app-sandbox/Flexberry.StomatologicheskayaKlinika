...
moduleForModel('i-i-s-stomatologicheskaya-klinika-запись', 'Unit | Serializer | i-i-s-stomatologicheskaya-klinika-запись', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-stomatologicheskaya-klinika-запись',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
