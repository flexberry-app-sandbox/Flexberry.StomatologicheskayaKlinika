...
moduleForModel('i-i-s-stomatologicheskaya-klinika-услуга', 'Unit | Serializer | i-i-s-stomatologicheskaya-klinika-услуга', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-stomatologicheskaya-klinika-услуга',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
