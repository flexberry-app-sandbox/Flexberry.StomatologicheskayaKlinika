...
moduleForModel('i-i-s-stomatologicheskaya-klinika-документы', 'Unit | Serializer | i-i-s-stomatologicheskaya-klinika-документы', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-stomatologicheskaya-klinika-документы',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
