...
moduleForModel('i-i-s-stomatologicheskaya-klinika-оплата', 'Unit | Serializer | i-i-s-stomatologicheskaya-klinika-оплата', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-stomatologicheskaya-klinika-оплата',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
