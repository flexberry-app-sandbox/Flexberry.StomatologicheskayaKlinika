...
moduleForModel('i-i-s-stomatologicheskaya-klinika-должность', 'Unit | Serializer | i-i-s-stomatologicheskaya-klinika-должность', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-stomatologicheskaya-klinika-должность',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
