...
moduleForAcceptance('[AGAT] Acceptance | i i s stomatologicheskaya klinika сотрудник l');

test('testing i-i-s-stomatologicheskaya-klinika-сотрудник-l', function(assert) {
