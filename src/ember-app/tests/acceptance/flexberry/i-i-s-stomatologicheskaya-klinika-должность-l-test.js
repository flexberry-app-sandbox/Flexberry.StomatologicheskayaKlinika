...
moduleForAcceptance('[AGAT] Acceptance | i i s stomatologicheskaya klinika должность l');

test('testing i-i-s-stomatologicheskaya-klinika-должность-l', function(assert) {
