...
moduleForAcceptance('[AGAT] Acceptance | i i s stomatologicheskaya klinika производитель l');

test('testing i-i-s-stomatologicheskaya-klinika-производитель-l', function(assert) {
