...
moduleForAcceptance('[AGAT] Acceptance | i i s stomatologicheskaya klinika материал l');

test('testing i-i-s-stomatologicheskaya-klinika-материал-l', function(assert) {
