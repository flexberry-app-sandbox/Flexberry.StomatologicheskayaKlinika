...
moduleForAcceptance('[AGAT] Acceptance | i i s stomatologicheskaya klinika кабинет l');

test('testing i-i-s-stomatologicheskaya-klinika-кабинет-l', function(assert) {
